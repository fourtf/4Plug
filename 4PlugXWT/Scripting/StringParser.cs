...
namespace FPlug.Scripting
{
    public class StringParser
    {
        ...
        public Tuple<int, int> TextOffset = new Tuple<int, int>(1, 1);
        ...
        public Tuple<int, int> GetTextLocation(int position)
        {
            int line = 0;
            int column = 0;
            ...
            return new Tuple<int, int>(line + TextOffset.Item2, line == 0 ? column + TextOffset.Item1 : column + 1);
        }
