...
namespace FPlug.Scripting
{
    public class Source1SchemeFile : Source1ResourceFile
    {
        ...
        public Source1SchemeFile(FolderCache cache, string filename)
            : base (cache, filename)
        {
            if (Loaded)
            {
    ...
    public class Source1ResourceFile
    {
        ...
        public Source1ResourceFile(FolderCache cache, string filename)
        {
            //_script = script;

            Filename = filename = cache.TryResolvePath(filename, false);
