    ...
    public partial class ScriptType
    {
        public static readonly ScriptType Bool = new ScriptType(
            ...
            new Method[]
            {
                ...
                new Method("Log", null, new Lambda(v => v.Script.SettingsWindow.ErrorWindow.Log(v.CurrentObject.ToString(), Options.ErrorType.Log))),
            },
            new Property[]
            {
        ...
        public static readonly ScriptType String = new ScriptType(
            ...
            new Method[]
            {
                ...
                new Method("Log", null, new Lambda(v => v.Script.SettingsWindow.ErrorWindow.Log((string)v.CurrentObject, Options.ErrorType.Log))),
        ...
        public static readonly ScriptType StaticDirectory = new ScriptType(
            ...
            new Method[]
            {
                new Method("Exists", ScriptType.Bool, new ParamLambda((v, o) => v.CurrentObject = v.Script.FolderCache.DirectoryExists((string)o).Log()), ScriptType.String),
        ...
        public static readonly ScriptType Static = new ScriptType(
            ...
            new Method[]
            {
                new Method("TF2Scheme", _TF2Scheme, (script) => new ParamActivator(script, (sc, arg) => new Source1SchemeFile(sc, (string)arg)), ScriptType.String),
                new Method("TF2Res", _Source1Res, (script) => new ParamActivator(script, (sc, arg) => new Source1ResourceFile(sc, (string)arg)), ScriptType.String),
                new Method("Color", _Source1Res, (script) => new ParamActivator(script, (sc, arg) =>
                {
                    string[] S = ((string)arg).Split(new char[]{' ', ','},StringSplitOptions.RemoveEmptyEntries);
                    byte r, g, b, a = 255;
                    if (byte.TryParse(S[0], out r) && byte.TryParse(S[0], out g) && byte.TryParse(S[0], out b) && (S.Length == 3 || byte.TryParse(S[0], out a)))
                        return S.Length == 3 ? XColor.FromBytes(r, g, b) : XColor.FromBytes(r, g, b, a);
